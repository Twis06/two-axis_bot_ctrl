...
python3 run_all.py                            # tests + all analyses (~8 min)
```
...
| `tests/` | simulator validation (18) and controller safety tests (10) |
...
- ✅ Phase 2: baseline controller, governor, drive supervisor
