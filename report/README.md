...
| 5. Test your explanation | [task5.md](task5.md) | A prospective closed-loop prediction, committed before the runs, is **supported** in simulation ([protocol](../docs/plans/task5-prospective-protocol.md), [numbers](task5_prospective_numbers.md)). The earlier motor-strength study is kept as a qualified, retrospectively corrected secondary result ([R2](packets/R2.md)). Hardware confirmation is proposed |
