...
To regenerate Figure 8 in PNG, SVG and standalone vector PDF form, run `uv run --group report python report/html_assets/holdability_figure.py`. The memo PDF embeds the SVG version; the HTML report embeds the PNG.
