...
FIGURES = {
    ...
    'task5': [('task5_prospective.png', 'Prospective Task 5 test', 'Registered prediction and acceptance region (committed before the runs) against the five measured paired changes and their mean (the pairs agree within 0.0003 and overlap the mean); right, per-run gain and phase. Simulated.')],
